...
class Form_ShortcutsEdit extends Zend_Form
{
    ...
    public function init()
    {
       ...
       My_Plugin_Form::setDefaultLayout($this->getElement('subsection_id'));

       // Add the Description element
       $this->addElement('text','description', array(
          'label' => 'Additional Notes (optional)'
          , 'filters' => array('StringTrim')
          , 'validators' => array(array('validator' => 'StringLength', 'options' => array(0,50)))
       ));
       ...
       // Add a hidden field to handle the shortcut id
